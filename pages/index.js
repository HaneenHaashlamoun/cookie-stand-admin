  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <main className="min-h-screen bg-green-50">
        ...
        <form className="flex-col w-4/6 p-2 mx-auto my-8 bg-green-300 rounded-md" onSubmit={Handler} >
          <fieldset>
            <h1 className="my-3 text-2xl text-center" type='text'>Cookie Stand Admin</h1>
            <div className="flex w-100">
              <label className="ml-16 ">Location</label>
              <input name="location" className="flex w-10/12 ml-2 gray-100" />
            </div>
            <div className="flex w-4/5 gap-12 pt-4 ml-16 pb-6" >
              ...
              <div className="flex-col w-1/4 ">
                ...
                <input type='number' className="" name="max" />
              </div>
              <div className="flex-col w-1/4">
        ...
        <h2 className="text-center ">Report Table Coming Soon ...</h2>
        {sorted.map((i) =>
